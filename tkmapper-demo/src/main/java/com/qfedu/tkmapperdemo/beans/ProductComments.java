...
public class ProductComments {
     ...
     * 获取订单项（商品快照）ID
     *
     * @return order_item_id - 订单项（商品快照）ID
     */
     ...
     * 获取是否匿名（1是，0否）
     *
     * @return is_anonymous - 是否匿名（1是，0否）
     */
     ...
     * 获取是否回复(1:未回复，1:已回复)
     *
     * @return reply_status - 是否回复(1:未回复，1:已回复)
     */
     ...
     * 设置是否回复(1:未回复，1:已回复)
     *
     * @param replyStatus 是否回复(1:未回复，1:已回复)
     */
