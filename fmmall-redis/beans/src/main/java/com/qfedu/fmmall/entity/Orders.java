...
public class Orders {
    ...
    /**
     * 订单状态1:待付款 2:待发货 3:待收货 4:待评价  5:已完成 6:已关闭
     */
    ...
    /**
     * 订单关闭类型1-超时未支付 2-退款关闭 4-买家取消 15-已经通过货到付款交易
     */
    ...
    /**
     * 获取订单状态1:待付款 2:待发货 3:待收货 4:待评价  5:已完成 6:已关闭
     *
     * @return status - 订单状态1:待付款 2:待发货 3:待收货 4:待评价  5:已完成 6:已关闭
     */
    ...
    /**
     * 设置订单状态1:待付款 2:待发货 3:待收货 4:待评价  5:已完成 6:已关闭
     *
     * @param status 订单状态1:待付款 2:待发货 3:待收货 4:待评价  5:已完成 6:已关闭
     */
    ...
    /**
     * 获取订单关闭类型1-超时未支付 2-退款关闭 4-买家取消 15-已经通过货到付款交易
     *
     * @return close_type - 订单关闭类型1-超时未支付 2-退款关闭 4-买家取消 15-已经通过货到付款交易
     */
    ...
    /**
     * 设置订单关闭类型1-超时未支付 2-退款关闭 4-买家取消 15-已经通过货到付款交易
     *
     * @param closeType 订单关闭类型1-超时未支付 2-退款关闭 4-买家取消 15-已经通过货到付款交易
     */
