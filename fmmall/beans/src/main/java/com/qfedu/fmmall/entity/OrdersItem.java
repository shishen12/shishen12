...
public class OrdersItem {
     ...
     * 获取评价状态：0未评价 1：已评价
     *
     * @return is_comment - 评价状态：0未评价 1：已评价
     */
     ...
     * 设置评价状态：0未评价 1：已评价
     *
     * @param isComment 评价状态：0未评价 1：已评价
     */
    ...
    public OrdersItem(String itemId, String orderId, String productId, String productName, String productImg, String skuId, String skuName, BigDecimal productPrice, Integer buyCounts, BigDecimal totalAmount, Date basketDate, Date buytime, Integer isComment) {
        this.itemId = itemId;
        this.orderId = orderId;
        this.productId = productId;
        this.productName = productName;
